...
@Repository
public interface WorkoutRepository extends PagingAndSortingRepository<Workout, UUID>, JpaRepository<Workout, UUID> {
	...
	List<Workout> findAllByUser(User user, PageRequest pagination);
